...
const ArtistsPage: React.FC = () => {
  ...
  const artists: ArtistNode[] = [
    {
      ...
      name: 'Bruce Melodie',
      genre: 'Afro-beat / R&B',
      bio: 'Known as "The New King", Bruce Melodie is a multiple award-winning artist and the first Rwandan to perform at major global arenas.',
      ...
      songs: ['Katerina', 'Ikinya', 'Sawa Sawa']
    },
    {
      id: 'a2',
      name: 'Meddy',
      genre: 'R&B / Soul',
      bio: 'Meddy is a pioneer of the modern R&B movement in Rwanda. His hit "Slowly" remains one of the most streamed Rwandan songs of all time.',
      stats: '850K+ Monthly Pulse',
      ...
      songs: ['Slowly', 'Holy Spirit', 'Queen of Sheba']
    },
    {
      id: 'a3',
      name: 'The Ben',
      genre: 'Pop / Afro-Soul',
      bio: 'A powerhouse vocalist known for his romantic ballads and high-energy performances. The Ben has collaborated with international stars.',
      stats: '920K+ Monthly Pulse',
      ...
      songs: ['Vazi', 'Can’t Get Enough', 'Habibi']
    }
  ];

  // Effect to automatically generate/fetch an extended bio when an artist is selected
  useEffect(() => {
  ...
  const handleGenerateExtendedBio = async (artist: ArtistNode) => {
    ...
    try {
      ...
      const response = await ai.models.generateContent({
        ...
        contents: `Generate a comprehensive, professional 4-paragraph biography for the artist "${artist.name}" (${artist.genre}). 
        ...
        Tone should be authoritative, like a high-end music journal.`,
      });
      setExtendedBio(response.text || "Neural connection timeout. Local data persistent.");
    } catch (err) {
      console.error(err);
      setExtendedBio(null); // Fallback to local bio if AI fails
    } finally {
  ...
  const handleArtistSelect = (artist: ArtistNode) => {
    setExtendedBio(null); // Reset for new selection
  ...
  if (selectedArtist) {
    return (
      <div className="animate-fade-in pb-32 space-y-8">
        ...
        {/* DEDICATED BIOGRAPHY SECTION (BELOW HEADER) */}
        <section className="max-w-4xl mx-auto space-y-12">
            ...
            <div className="relative z-10 space-y-10">
              <div className="flex items-center gap-4 border-b border-slate-800 pb-8">
                ...
                {isGeneratingBio && (
                  <div className="ml-auto flex items-center gap-3">
                    ...
                    <span className="text-[9px] font-black text-slate-500 uppercase tracking-widest">Generating Insight...</span>
                  </div>
                )}
              </div>
              ...
              <div className="flex flex-wrap items-center gap-6 pt-10 border-t border-slate-800">
                 ...
                 <a 
                   ...
                   target="_blank" 
                   rel="noreferrer"
                   className="ml-auto bg-white text-slate-950 px-8 py-3 rounded-2xl font-black uppercase text-[10px] tracking-widest hover:scale-105 transition-all shadow-xl"
                 >
          ...
          <div className="space-y-8">
             <h3 className="text-2xl font-black text-white italic uppercase tracking-tight ml-4 flex items-center gap-4">
               <i className="fa-solid fa-compact-disc text-blue-500"></i> High-Pulse Extractions
             </h3>
                 ...
                 <div key={i} className="bg-slate-900/50 border border-slate-800 rounded-3xl p-6 flex items-center justify-between group hover:bg-blue-600/5 hover:border-blue-600/30 transition-all cursor-pointer">
                    <div className="flex items-center gap-6">
                      ...
                      <div>
                        ...
                        <p className="text-[9px] font-black text-slate-600 uppercase tracking-widest">Zetta Protocol Verified</p>
                      </div>
                    </div>
  ...
  return (
    <div className="space-y-12 animate-fade-in pb-32">
      <header className="border-b border-slate-800 pb-10">
        ...
        <p className="text-slate-400 font-medium italic mt-2">Verified creator nodes currently streaming within the Zetta infrastructure.</p>
      </header>
